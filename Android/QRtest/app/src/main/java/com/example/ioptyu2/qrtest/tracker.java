...
public class tracker extends FragmentActivity implements LocationListener, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void createLocationRequest() {
       ...
       /**
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            LatLng sydney = new LatLng(46.204391, 6.1432);
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                ...
                Toast.makeText(getApplicationContext(),"Access Denied niewby", Toast.LENGTH_SHORT).show();
